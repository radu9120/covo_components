...
const { title, description } = {
  title: "Covo Components - Blog",
  description: "The latest about Covo Components, and some technical stuff.",
};
      ...
      <section className="max-w-3xl px-4 mx-auto mt-base">
        <div className="text-center mt-20">
          ...
          <p className="mt-3 text-lg text-gray-400">
            The latest about Covo Components, and some technical stuff.
          </p>
        </div>
        <ul className="mt-12">
